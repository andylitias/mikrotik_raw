...
# ==========================================================
/ip dns set servers="" use-doh-server="https://cloudflare-dns.com/dns-query" verify-doh-cert=yes allow-remote-requests=yes doh-max-server-connections=20 doh-max-concurrent-queries=200 cache-size=8192KiB
/ip dns cache flush
